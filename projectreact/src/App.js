...
function App(){
  return(
    <div className="app">
      ...
      <Episode title="Episode 4" name="Trojan Horse">Raquel sends her police partner Ángel Rubio undercover with a medical team that is allowed inside the Mint to treat Arturo, who was mistakenly shot for one of the robbers by the police. However, the Professor sees through her move and comes up with his own plan to gain an advantage on her by inserting a bug in Ángel's glasses.</Episode>
      <Episode title="Episode 5" name="Groundhog Day">The Professor runs ahead of the police to get rid of an important piece of evidence that can endanger his plans, their finger prints in a car at a scrap yard that Helsinki neglected to destroy. Meanwhile, Denver treats Mónica in a secret location after he shot her leg to fake her execution, and they end up becoming closer.</Episode>
